...
impl Error {
  pub fn new(message: &str) -> Error {
    return Error { message: String::from(message) };
  }
  pub fn bad_config() -> Error {
    return Error { message: String::from("Bad configuration") };
  }
  pub fn unimplemented() -> Error {
    return Error { message: String::from("Not implemented") };
  }
  pub fn disconnected() -> Error {
    return Error { message: String::from("Disconnected") };
  }
}
